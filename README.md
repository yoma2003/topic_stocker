...
# アプリケーション名
<span style="font-size: 24px">Topic Stocker</span>

# URL
<span style="font-size: 20px"> https://topicstocker.com/</span>
...
- 「アカウント登録」からユーザー情報を登録し、ログインする。<br>
  **<span style="color: red; font-size: 18px">※試用の場合は「ゲストログイン」からログイン可能。</span>**

- ユーザー情報の編集はトップページ右上のプルダウンから可能。
...
**<span style="color: red;">（フォーム外クリックで自動更新）</span>**<br>

- 編集したい人の「詳細編集」から登録情報の詳細を編集する。<br>
**<span style="color: red;">（フォームの追加・削除で、「何を話したか」は連続して登録できる）</span>**
